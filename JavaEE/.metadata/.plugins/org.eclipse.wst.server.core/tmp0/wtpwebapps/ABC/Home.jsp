    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        ...
        <div class="carousel-caption">
		  ...
		  <hr>
          <p>Do your shopping online!Find out various electronic components.Different technologies,prices,offers for all our customers.Let's learn more on Tronic Mart</p>
        </div>
      </div>
...
<div class="container text-center" id="about">
  <h3><b>ABC</b></h3>
  <p><b>Co-create products with our customers</b></p>
  <p><b>VALUE - DELIVERY - POWER - CARE</b></p>
</div>
<div id="tour" class="cas">
	 ...
	 <div class="row text-center">
      ...
      <div class="col-sm-4">
        <div class="thumbnail">
          ...
          <a href="phone.jsp"><button class="btn">Search</button></a>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="img/Veh.jpg" alt="Vehicle" width="400" height="300">
          <p><strong>Vehicle Electronics and GPS</strong></p>
        
          <a href="vehicle.jsp"><button class="btn">Search</button></a>
        </div>
      </div>
	   <div class="col-sm-2">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-envelope"></span> abccompany@hotmail.com</p>
    </div>
    <div class="col-sm-7">
      <div class="row">
