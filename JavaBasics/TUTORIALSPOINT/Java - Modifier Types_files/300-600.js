...
lib.properties = {
	...
	color: "#FFCE04",
	manifest: [
		{src:"images/_300600_1.jpg", id:"_300600_1"},
...
(lib._300600 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(167.7,568.7,1.129,1.125,0,0,0,113.6,10);
	...
	this.instance_1.setTransform(164.6,424.3,1.24,1.24,0,0,0,50,44.6);
	...
	this.instance_2.setTransform(168.3,568.6,1.118,1.115,0,0,0,115.2,10);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:true},599).wait(6));

	// Layer 2
	this.instance_3 = new lib.Symbol1();
	this.instance_3.setTransform(164.1,424.3,1.234,1.233,0,0,0,50,44.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},599).wait(6));

	// Layer 1
	this.instance_4 = new lib._300600_1();
	this.instance_4.setTransform(-0.5,0,1.003,1.003);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(605));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149.5,300,301,602);


// symbols:
(lib._300600_1 = function() {
	this.initialize(img._300600_1);
